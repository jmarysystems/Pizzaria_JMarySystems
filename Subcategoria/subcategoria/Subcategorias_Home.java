 ...
 * @author pc
 */
public class Subcategorias_Home extends javax.swing.JPanel {

    public Home                          Home;
    public JTabbedPane                   tabHome;
    
    public Subcategorias_Home_Inicio     Inicio;
            
    /**
     * Creates new form Fonema_E_Letra_Home
     * @param Home2
     */
    public Subcategorias_Home( Home Home2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
                                
        Inicio = new Subcategorias_Home_Inicio( this );                
    }
