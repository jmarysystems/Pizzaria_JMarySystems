 ...
 * @author pc
 */
public class Produtos_Home extends javax.swing.JPanel {

    public Home                                   Home;
    public JTabbedPane                            tabHome;
    
    public Produtos_Home_Inicio       Inicio;
            
    /**
     * Creates new form Fonema_E_Letra_Home
     * @param Home2
     */
    public Produtos_Home( Home Home2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
                                        
        Inicio = new Produtos_Home_Inicio( this );
    ...
    public Produtos_Home( Home Home2, Venda_New Venda_New2 ) {
        initComponents();
        ...
        Inicio = new Produtos_Home_Inicio( this, Venda_New2 );
