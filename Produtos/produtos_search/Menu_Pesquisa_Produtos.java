 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Produtos extends javax.swing.JPanel {

    Produtos_Home  Produtos_Home;
    public  int    IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Produtos Tabela_Pesquisa_BD_Produtos;
     
    /**
     * Creates new form Cliente
     */
    public Menu_Pesquisa_Produtos( Produtos_Home Produtos_Home2 ) {
        initComponents();
    ...
    //////////////////////////////////////////////////////////////////////
     public Menu_Pesquisa_Produtos( Produtos_Home Produtos_Home2, Venda_New Venda_New2 ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.PRODUTOS WHERE ID = ?", Produtos.class );
                             ...
                             Produtos_Home.Venda_New.setarNoJPanelProdutosSelecionado( Produtos );
                         }
                         else{
    ...
    public void tabela(Tabela_Pesquisa_BD_Produtos Tabela_Pesquisa_BD_Produtos2 ){ 
                
        try {                
            Tabela_Pesquisa_BD_Produtos = Tabela_Pesquisa_BD_Produtos2;                                    
    ...
    private void initComponents() {
        ...
        rbNome.setText("Descrição do Produto");
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.PRODUTOS WHERE NOME LIKE ?", produtos.Produtos.class );
            if( !tf.equals("") ){
            ...
            if(q != null) { Tabela_Pesquisa_BD_Produtos.pesquisa(q); }
            ...
            if( btAlterar.isEnabled() ) {            
                if( IDSELECIONADA > 0 ) {
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Produtos_New New = new Produtos_New( Produtos_Home, Produtos );
                        Produtos_Home.Home.ControleTabs.AddTabSemControleNovo(Produtos_Home.tabHome, "Visualizar", "/utilidades_imagens/olho.png", New );
                        ...
                        Produtos_New New = new Produtos_New( Produtos_Home, Produtos );
                        Produtos_Home.Home.ControleTabs.AddTabSemControleNovo(Produtos_Home.tabHome, "Alterar", "/utilidades_imagens/alterar.gif", New );
                    }
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
