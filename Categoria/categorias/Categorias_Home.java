 ...
 * @author pc
 */
public class Categorias_Home extends javax.swing.JPanel {

    public Home                       Home;
    public JTabbedPane                tabHome;
    
    public Categorias_Home_Inicio     Inicio;
        
    /**
     * Creates new form Fonema_E_Letra_Home
     * @param Home2
     */
    public Categorias_Home( Home Home2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
                                
        Inicio = new Categorias_Home_Inicio( this );                
    }
