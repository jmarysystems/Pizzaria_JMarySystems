 ...
 * @author pc
 */
public class Materias_Home extends javax.swing.JPanel {

    public Home                       Home;
    public JTabbedPane                tabHome;
    
    public Materias_Home_Inicio       Inicio;
            
    /**
     * Creates new form Fonema_E_Letra_Home
     * @param Home2
     */
    public Materias_Home( Home Home2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
                                
        Inicio = new Materias_Home_Inicio( this );
