 ...
 */
@Entity
@Table(name = "CLIENTES", catalog = "", schema = "SCHEMAJMARY")
@NamedQueries({
    ...
    @NamedQuery(name = "Clientes.findByPontodereferencia", query = "SELECT c FROM Clientes c WHERE c.pontodereferencia = :pontodereferencia"),
...
public class Clientes implements Serializable {
    ...
    @Column(name = "PONTODEREFERENCIA", length = 150)
    ...
    public void setPontodereferencia(String pontodereferencia) {
        String oldPontodereferencia = this.pontodereferencia;
        this.pontodereferencia = pontodereferencia;
        changeSupport.firePropertyChange("pontodereferencia", oldPontodereferencia, pontodereferencia);
    }
