 ...
 * @author ana
 */
public class Tabela_Pesquisa_BD_Clientes extends javax.swing.JPanel {
   
    private Clientes_Home          Clientes_Home;
    private Menu_Pesquisa_Clientes Menu_Pesquisa;
        
    private List<clientes.Clientes> list;
    private ListSelectionModel               lsmPesquisa;
    private final DefaultTableModel          tmPesquisa = new DefaultTableModel( null, new String[]{ "     ID","NOME DO CLIENTE", "TELEFONE", "ENDEREÇO", "NÚMERO"} );
    
    public Tabela_Pesquisa_BD_Clientes( Clientes_Home Clientes_Home2 ) {
    ...
    public void tabela(Menu_Pesquisa_Clientes Menu_Pesquisa2){ 
    ...
    private void tbPreferedSize(){        
        try{
            ...
            tbPesquisa.getColumnModel().getColumn(3).setPreferredWidth(260);
    ...
    public void mostrarLista( List<clientes.Clientes> listR ){  try {                    
            ...
            if ( listR.isEmpty() ){ //JOptionPane.showMessageDialog( null , "Nenhum dado encontrado!"); 
                ...
                for (int i = 0; i < listR.size(); i++){
                    ...
                    tmPesquisa.setValueAt( listR.get(i).getTelefone()            , i, 2);
                    tmPesquisa.setValueAt( listR.get(i).getEndereco()            , i, 3);
                    tmPesquisa.setValueAt( listR.get(i).getNumero()              , i, 4);
                }
            }    
