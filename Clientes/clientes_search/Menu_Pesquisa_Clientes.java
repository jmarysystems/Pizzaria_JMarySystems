 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Clientes extends javax.swing.JPanel {

    Clientes_Home  Clientes_Home;
    public  int    IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Clientes Tabela_Pesquisa_BD_Clientes;
     
    /**
     * Creates new form Cliente
     */
    public Menu_Pesquisa_Clientes( Clientes_Home Clientes_Home2 ) {
        initComponents();
    ...
    public Menu_Pesquisa_Clientes( Clientes_Home Clientes_Home2, Menu_Pesquisa_Venda Menu_Pesquisa_Venda2 ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Clientes_Home.Menu_Pesquisa_Venda.setarNoJPanelClientesSelecionado( Clientes );
    ...
    ////Menu_Pesquisa_Gestor2//////////////////////////////////////////////////////////////////
    public Menu_Pesquisa_Clientes( Clientes_Home Clientes_Home2, Venda_New Venda_New2 ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             Clientes_Home.Venda_New.setarNoJPanelClientesSelecionado( Clientes );
    ...
    ////Menu_Pesquisa_Gestor2//////////////////////////////////////////////////////////////////
    public Menu_Pesquisa_Clientes( Clientes_Home Clientes_Home2, JTabbedPane tabHome ) {
        initComponents();
                    ...
                    ////////////////////////////
                     if( btSelecionar.isEnabled() ) {            
                         if( IDSELECIONADA > 0 ) {
                             ...
                             String str = Clientes.getNome();
                             Venda_Home Venda_Home = new Venda_Home( Clientes_Home.Home, Clientes_Home.tabHome, Clientes );
                             
                             Clientes_Home.Home.ControleTabs.removerTabSemControleSelecionado( Clientes_Home.tabHome );
                             try { Thread.sleep( 3 ); 
                             
                                 Clientes_Home.Home.ControleTabs.AddTabSemControleNovo( Clientes_Home.tabHome, str, "/utilidades_imagens/novo.gif", Venda_Home );
    ...
    public void tabela(Tabela_Pesquisa_BD_Clientes Tabela_Pesquisa_BD_Clientes2 ){ 
                
        try {                
            Tabela_Pesquisa_BD_Clientes = Tabela_Pesquisa_BD_Clientes2;                                    
    ...
    private void initComponents() {
        ...
        rbNome.setText("Nome do Cliente");
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.CLIENTES WHERE NOME LIKE ?", clientes.Clientes.class );
            if( !tf.equals("") ){
            ...
            if(q != null) { Tabela_Pesquisa_BD_Clientes.pesquisa(q); }
            ...
            if( btAlterar.isEnabled() ) {            
                if( IDSELECIONADA > 0 ) {
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Clientes_New New = new Clientes_New( Clientes_Home, Clientes );
                        Clientes_Home.Home.ControleTabs.AddTabSemControleNovo(Clientes_Home.tabHome, "Visualizar", "/utilidades_imagens/olho.png", New );
                        ...
                        Clientes_New New = new Clientes_New( Clientes_Home, Clientes );
                        Clientes_Home.Home.ControleTabs.AddTabSemControleNovo(Clientes_Home.tabHome, "Alterar", "/utilidades_imagens/alterar.gif", New );
                    }
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
