 ...
 */
package assunto_search;

import assunto.Assunto;
 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Assunto extends javax.swing.JPanel {

    Assunto_Home                       Assunto_Home;
    public  int                        IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Assunto  Tabela_Pesquisa_BD_Assunto;
     
    /**
     * Creates new form Cliente
     * @param Assunto_Home2
     */
    public Menu_Pesquisa_Assunto( Assunto_Home Assunto_Home2 ) {
        initComponents();
    ...
    private void inicioCBS(){        
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 );         
            ...
            cbSubcategoria.setBackground( c );            
                ...
                + e.getMessage() + "\n", "Menu_Pesquisa_Assunto" ); } } }.start();       
    }
    
    public void tabela(Tabela_Pesquisa_BD_Assunto Tabela_Pesquisa_BD_Assunto2){ 
                
        try {                
            Tabela_Pesquisa_BD_Assunto = Tabela_Pesquisa_BD_Assunto2;                                    
        } catch( Exception e ){ e.printStackTrace(); JOPM JOptionPaneMod = new JOPM( 2, "tabela, \n"
                + e.getMessage() + "\n", "Menu_Pesquisa_Assunto" ); }     
    }
    ...
    private void initComponents() {
        ...
        cbtipoP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TODOS", "NOME", "NOME E MATÉRIA", "MATÉRIA E CATEGORIA", "MATÉRIA, CATEGORIA E SUBCATEGORIA" }));
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addComponent(cbtipoP, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            String op = cbtipoP.getSelectedItem().toString().trim();
            if( op.equals("TODOS") ) {
                q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.ASSUNTO WHERE ASSUNTO LIKE ?", assunto.Assunto.class );
                q.setParameter(1, "%"+tf+"%");
            }
                ...
                q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.ASSUNTO WHERE ASSUNTO LIKE ? AND ID_MATERIA = ?", assunto.Assunto.class );
                q.setParameter(1, "%"+tf+"%");
                ...
                q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.ASSUNTO WHERE ASSUNTO LIKE ? AND ID_MATERIA = ? AND ID_CATEGORIA = ?", assunto.Assunto.class );
                q.setParameter(1, "%"+tf+"%");
                q.setParameter(2, obj.ID ); 
                ...
                q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.ASSUNTO WHERE ASSUNTO LIKE ? AND ID_MATERIA = ? AND ID_CATEGORIA = ? AND ID_SUBCATEGORIA = ?", assunto.Assunto.class );
                q.setParameter(1, "%"+tf+"%");
                q.setParameter(2, obj.ID ); 
                q.setParameter(3, obj2.ID ); 
            ...
            Tabela_Pesquisa_BD_Assunto.pesquisa(q);
            //if(q != null) { Tabela_Pesquisa_BD_Assunto.pesquisa(q); }
                        
        } catch( Exception e ){ try{ Query q2 = null; Tabela_Pesquisa_BD_Assunto.pesquisa(q2); }catch(Exception e2 ){}
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    String excluir = "DELETE FROM SCHEMAJMARY.ASSUNTO WHERE ID = ?";
        ...
        try { Thread.sleep( 1 ); 
            ...
            if( btAlterar.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.ASSUNTO WHERE ID = ?", assunto.Assunto.class );
                    q.setParameter(1, IDSELECIONADA);   
                    
                    List<assunto.Assunto> list = q.getResultList();
                    
                    for (int i = 0; i < list.size(); i++){ Assunto = list.get(i); }
                    
                    if( str.equals( "Visualizar") ){
                        
                        Assunto_New New = new Assunto_New( Assunto_Home, Assunto );
                        Assunto_Home.Home.ControleTabs.AddTabSemControleNovo( Assunto_Home.tabHome, "Visualizar", "/utilidades_imagens/olho.png", New );
                        ...
                        Assunto_New New = new Assunto_New( Assunto_Home, Assunto );
                        Assunto_Home.Home.ControleTabs.AddTabSemControleNovo( Assunto_Home.tabHome, "Alterar", "/utilidades_imagens/alterar.gif", New );
                    }
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
